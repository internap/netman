...
class BrocadeTest(unittest.TestCase):
    ...
    def test_get_vlan_with_both_ip_and_ipv6_vrrp_groups(self):
        self.command_setup()
        ...
        assert_that(len(vrrp_group2.ips), equal_to(1))
        assert_that(vrrp_group2.ips[0], equal_to(IPAddress('2001:47c2:19:5::1')))
        assert_that(vrrp_group2.hello_interval, equal_to(5))
        assert_that(vrrp_group2.priority, equal_to(110))
        assert_that(vrrp_group2.track_id, equal_to('ethernet 1/2'))
        assert_that(vrrp_group2.track_decrement, equal_to(50))
    ...
    def test_get_vlan_with_both_ip_and_ipv6_in_the_same_vrrp_group(self):
        ...
        assert_that(len(vrrp_group.ips), equal_to(2))
        assert_that(vrrp_group.ips[0], equal_to(IPAddress('1.1.1.2')))
        assert_that(vrrp_group.ips[1], equal_to(IPAddress('2001:47c2:19:5::1')))
