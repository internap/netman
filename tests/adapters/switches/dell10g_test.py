...
class Dell10GTest(unittest.TestCase):
    ...
    def test_get_vlan_interfaces(self):
        ...
        assert_that(vlan_interfaces, equal_to(['port-channel 2', 'port-channel 3', 'port-channel 5',
                                               'port-channel 6', 'port-channel 7', 'tengigabitethernet 0/0/1',
                                               'tengigabitethernet 0/0/2']))
    ...
    def test_mac_addresses(self):
        ...
        assert_that(mac[0].mac_address, is_("0025.906B.DACF"))
        assert_that(mac[0].interface, is_("Te1/0/4"))

        assert_that(mac[1].vlan, is_("1234"))
        assert_that(mac[1].mac_address, is_("0025.906B.DBFF"))
        assert_that(mac[1].interface, is_("Te1/0/2"))

        assert_that(mac[2].vlan, is_("3217"))
        assert_that(mac[2].mac_address, is_("0025.9097.70EB"))
